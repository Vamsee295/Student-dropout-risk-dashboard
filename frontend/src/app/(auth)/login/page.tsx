        ...
        <div className="bg-white p-8 rounded-2xl shadow-xl border border-gray-100 max-w-md w-full transition-all duration-300">
            <div className="text-center mb-8">
                ...
                <p className="text-sm text-gray-500 mt-2">
                    {isForgotMode ? "Reset your password" : "Faculty Login"}
                </p>
            </div>
            ...
            <div className="mt-8 text-center pt-6 border-t border-gray-100">
                <p className="text-xs text-gray-400">
                    Test Credentials: <span className="font-mono bg-gray-50 px-1 py-0.5 rounded">faculty1@gmail.com</span> / <span className="font-mono bg-gray-50 px-1 py-0.5 rounded">password</span>
                </p>
            </div>
        </div>
    );
